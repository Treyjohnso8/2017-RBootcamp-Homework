...
#“mean_heights_1000”.
for (i in 1:1000){
  mean_heights_1000<-data.frame(sample_heights = 1000)
} 
mean_heights_1000                                                                                
...
#the next page.
bins<-seq(0,50,by=1)
hist1000<-hist(mean_heights_1000)
hist100<-hist(mean_heights_100)
par(mfrow=c(1,1), mar=c(4, 4, 3, 2))
barplot(c(hist1000,mean_heights_100),col=c(2,4),beside=T,
